...
public:
    ...
    ManageMenu(){//constructor for manage menu class
...
public:
 ...
 //get details class
    ...
    void showDetails() //to show old customer records
    {
...
int Customer::cusID;//id is declared static
...
public:
    ...
    void cabDetails(){
        ...
        cout << "-----------Urban Cabs-----------\n" << endl;
        cout << "1. Rent a Auto - Rs.15 for 1KM" << endl;
        cout << "2. Rent a Cab - Rs.25 per 1KM" << endl;
...
public:
    ...
    void hotels(){
        string hotelNo[] = {"Hotel Taj", "May Fair", "Rainbow"};
        for(int a = 0; a < 3; a++) cout << (a+1) <<". Hotel " << hotelNo[a] << endl;
        ...
        if(choiceHotel == 1){
            ...
            if (packChoice1 == 1){
                hotelCost = 15000.00;
                cout << "You have successfully booked Family Pack at MAYFAIR" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "You have successfully booked Couple Pack at MAYFAIR" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 5000.00;
                cout << "You have successfully booked Single Pack at MAYFAIR" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "You have successfully booked RAINBOW Special Pack" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
...
public:
    ...
    void printBill(){
        ...
        outf.close();
        cout << "Your receipt printed, please get it from the receipt file." << endl;
    }
...
void menu() //menu function contain main menu
{
    ...
    if(mainChoice == 1){
        ...
        system("CLS");
        if(inChoice == 1) a2.getDetails();
        else if(inChoice == 2) a2.showDetails();
        else{
            cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            Sleep(1100);
            system("CLS");
    ...
    else if(mainChoice == 2) a3.cabDetails();    
